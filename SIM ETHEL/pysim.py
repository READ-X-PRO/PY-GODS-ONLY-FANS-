...
class PySimApp:
    def __init__(self, root):
        self.root = root
        self.root.title("PySIM Manager - Xbox Edition")
    ...
    def create_header(self):
        ...
        ttk.Label(header, text="Xbox Edition", style="Subheader.TLabel").pack(side='left', padx=(10, 0), pady=20)
    ...
    def create_logs_tab(self):
        ...
        AnimatedButton(btn_frame, "Export Data", lambda: None, width=120, height=35).pack(side='left', padx=10)
    ...
    def save_logs(self):
        with open("pysim_logs.txt", "w") as f:
            f.write("\n".join(self.log_events))
        self.log_event("Logs saved to pysim_logs.txt")
